  ...
  return (
    <div
      ...
      style={{
        ...
        aspectRatio: '16/9',
        width: '100%',
        cursor: userClicked ? 'default' : 'pointer',
      }}
    >
      {/* Remote video */}
      <video
        ...
        <div style={{
          ...
          {isLoading ? (
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#f7b731', fontSize: 14, maxWidth: 280, lineHeight: 1.6 }}>{videoError}</p>
              <p style={{ color: '#5050a0', fontSize: 13, marginTop: 8 }}>Text chat is working below ↓</p>
            </div>
          ) : (
            <>
              <div style={{ width: 40, height: 40, border: '2px solid #6b8fff', borderTopColor: 'transparent', borderRadius: '50%', animation: 'spin 0.8s linear infinite' }} />
              <p style={{ color: '#5050a0', fontSize: 14 }}>Connecting to {partnerName || 'partner'}...</p>
            </>
          )}
        </div>
      )}
